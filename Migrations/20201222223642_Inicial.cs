    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Aluguel = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemAluguel", x => new { x.Id_Aluguel, x.Id_Livro });
                    table.ForeignKey(
                        name: "FK_ItemAluguel_Aluguel_Id_Aluguel",
                        column: x => x.Id_Aluguel,
                        principalTable: "Aluguel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemAluguel_Livro_Id_Livro",
                        column: x => x.Id_Livro,
